...
export default function TermsOfService() {
  return (
    <Box margin='5% 15%'>
      ...
      <Box>
        <Typography>1. Information We Collect and Receive</Typography>
      ...
      <Box>
        <Typography>2. Use of Personal Information</Typography>
      ...
      <Box>
        <Typography>3. Updating and Deleting Your Information</Typography>
